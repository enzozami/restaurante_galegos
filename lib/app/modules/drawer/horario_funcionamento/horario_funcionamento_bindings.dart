...
import 'horario_funcionamento_controller.dart';

class HorarioFuncionamentoBindings implements Bindings {
  @override
  void dependencies() {
    ...
    Get.put(HorarioFuncionamentoController(timeServices: Get.find<TimeServices>()));
  }
}
