  ...
  return SingleChildScrollView(
    child: Column(
      ...
      children: [
        ...
        (controller.productSelected?.image != null && controller.productSelected!.image.isNotEmpty)
            ? Center(
                child: Image.network(
                  controller.productSelected!.image,
                  fit: BoxFit.cover,
          ...
          child: SizedBox(
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Text(
                  controller.productSelected?.name ?? '',
          ...
          child: SizedBox(
            ...
            child: Card(
              ...
              child: Padding(
                padding: const EdgeInsets.symmetric(vertical: 15, horizontal: 20),
                child: Text(
                  FormatterHelper.formatCurrency(controller.productSelected?.price ?? 0),
                  style: theme.textTheme.bodyLarge,
                ),
              ),
            ),
          ...
          child: Form(
            child: Column(
              ...
              children: [
                ...
                (controller.productSelected!.image.isNotEmpty)
                    ? Center(
                        child: Image.network(
                          controller.productSelected!.image,
                          fit: BoxFit.cover,
