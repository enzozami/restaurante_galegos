  ...
  return SingleChildScrollView(
    child: Column(
      ...
      children: [
        ...
        (controller.foodSelected.image.isNotEmpty)
            ? Center(
                child: Image.network(
                  controller.foodSelected.image,
                  fit: BoxFit.cover,
        ...
        // Center(
        //   child: SectionHeader(
        //     items: controller.days.value
        //         .map(
        //           (d) => MultiSelectCard<String>(
        //             value: d,
        //             label: d[0],
        //             selected: controller.foodSelected.dayName.contains(d),
        //           ),
        //         )
        //         .toList(),
        //     onChanged: controller.onChangedSelectionFunctionDetail,
        //   ),
        // ),
        Center(
          child: SizedBox(
          ...
          child: SizedBox(
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Text(
                  controller.foodSelected.description,
        ...
        Column(
          spacing: 20,
          children: controller.foodSelected.pricePerSize.entries
              .map(
                (size) => Center(
                  child: SizedBox(
                    width: context.widthTransformer(reducedBy: 10),
              ...
              items: controller.times
                  ...
                  .map(
                    (e) => MultiSelectCard<String>(
                      value: e,
                      label: e[0],
                      selected: controller.foodSelected.dayName.contains(e),
                    ),
                  )
                  .toList(),
